...
id: S-120
description: >
  Detect stale (source changed) or missing (output deleted) llms-output
  pages via a content-hash manifest. Generalized from aspose.org's
  llms-stale skill (S-LG-05) -- ported 2026-08-29 (TASK_BACKLOG.md SYNC-7).
args: "[--output llms-output] [--update-manifest] [--check-only]"
---
