...
id: S-112
description: >
  Run full capability sync pipeline: inventory canonical registry, generate Claude
  command adapters, generate agent skill adapters, update discovery indexes, detect
  orphans, detect drift, validate parity, emit reports.
args: "[--check]"
---
