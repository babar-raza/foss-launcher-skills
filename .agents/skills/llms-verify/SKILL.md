...
id: S-119
description: >
  Verify live HTTP endpoints for deployed llms-output pages, for sites that
  have a base_url configured. Generalized from aspose.org's llms-verify
  skill (S-LG-02) -- ported 2026-08-29 (TASK_BACKLOG.md SYNC-6).
