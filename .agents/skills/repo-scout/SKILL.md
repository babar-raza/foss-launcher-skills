...
id: S-34
description: >
  Extract truth from a FOSS repository using tree-sitter analysis. Supports
  both source-repo and pip-install modes. Produces knowledge artifacts in
  scout/ for independent verification.
