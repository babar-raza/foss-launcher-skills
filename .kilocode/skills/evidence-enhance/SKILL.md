...
id: S-83
description: >
  Improve section-level evidence coverage on content pages that already pass
  validation (audit.py PASS, grade A or B). Governed entry point for
  attach_evidence.py --force on passing pages.
