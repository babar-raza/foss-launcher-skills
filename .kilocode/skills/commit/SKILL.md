...
id: S-81
description: >
  Stage and commit working tree changes with structured conventional commits.
  Groups changes by path prefix, enforces skills-invoked provenance on content
  commits, and runs quality gates before committing.
args: "[--scope {scope}] [--hint {guidance}]"
---
