...
id: S-95
description: >
  Agent-executed governed inspection. Replaces "human-review" dead-ends with
  bounded inspection, judgment, skill routing, re-verification, and a publish
  verdict: PUBLISH | CONDITIONAL | BLOCKED.
args: "{family} {platform} [--scope all|non-reference|reference|blog|kb|docs|products] [--grade-filter A,B,C,D,F] [--dry-run]"
---
