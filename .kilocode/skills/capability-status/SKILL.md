...
id: S-111
description: >
  Report current parity status across all agent adapter surfaces (Claude Code, Codex,
  KiloCode). Reads skills/registry.yaml and verifies each capability has complete adapters.
args: "[--verbose]"
---
