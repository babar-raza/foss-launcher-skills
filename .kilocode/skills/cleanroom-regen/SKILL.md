---
name: cleanroom-regen
id: S-106
description: >
  8-mode cleanroom regeneration workflow (inspect/snapshot/regen/diff/review/apply/verify/gate)
  for one family/platform target. Backed by scripts/pipeline/commands/ops/cleanroom_regen.py.
internal: false
script: scripts/pipeline/commands/ops/cleanroom_regen.py
---
