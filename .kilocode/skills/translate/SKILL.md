...
id: S-107
description: >
  Compatibility dispatcher for translation workflows. Routes file-path inputs
  to translate-page and family/platform inputs to translate-batch.
args: "{src_path locales | family platform [site] [locales]}"
---
