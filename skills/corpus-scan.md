...
id: S-37
description: >
  Scan existing content pages in the content repo to build a golden corpus
  profile that generation skills use for structural and stylistic consistency.
args: "{family} {platform} {site-type}"
---
