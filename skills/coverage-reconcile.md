...
id: S-85
description: >
  Produce a full disposition table for every knowledge unit (claim, API member)
  for a given product, showing coverage status: used in content, stored but
  unused, orphaned, or excluded by site planner.
