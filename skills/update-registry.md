...
id: S-73
description: >
  Discover and register FOSS repositories from Aspose GitHub organisations.
  Updates the product registry used by clone_cache and refresh_knowledge.
  See also: discover-products (S-39) for the foss-launcher discovery workflow.
args: "[--token TOKEN] [--local-only] [--force] [--dry-run]"
---
