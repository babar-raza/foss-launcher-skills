...
id: S-86
description: >
  Build a per-claim, per-API-class disposition table showing which knowledge
  units appear in no content page evidence block. The foundational observability
  instrument for "no silent knowledge loss."
