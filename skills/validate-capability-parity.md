---
name: validate-capability-parity
id: S-113
description: >
  Validate semantic parity across all agent adapter surfaces. Compares canonical skill
  bodies to deployed adapters. Emits .governance/generated/parity-report.yaml.
args: "[--check]"
---
