...
id: S-69
description: >
  Bootstrap the repo environment from a fresh clone to a content-ready state.
  Covers Python setup, credentials, product registry, knowledge bootstrapping,
  hook installation, and governance verification in 7 steps.
