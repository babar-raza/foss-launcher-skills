"""Re-export stub: content_audit.py moved to commands/content/audit.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.content.audit", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.content.audit")
