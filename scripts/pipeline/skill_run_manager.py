"""Re-export stub: skill_run_manager.py moved to commands/ops/skill_run_manager.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.skill_run_manager", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.skill_run_manager")
