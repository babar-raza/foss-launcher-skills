"""Re-export stub: truth_audit.py moved to commands/knowledge/truth_audit.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.knowledge.truth_audit", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.knowledge.truth_audit")
