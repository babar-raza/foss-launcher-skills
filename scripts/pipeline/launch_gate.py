"""Re-export stub: launch_gate.py moved to commands/launch/launch_gate.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.launch.launch_gate", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.launch.launch_gate")
