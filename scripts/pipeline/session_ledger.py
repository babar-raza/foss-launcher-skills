"""Re-export stub: session_ledger.py moved to commands/ops/session_ledger.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.session_ledger", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.session_ledger")
