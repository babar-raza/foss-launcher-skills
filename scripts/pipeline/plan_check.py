"""Re-export stub: plan_check.py moved to commands/governance/plan_check.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.governance.plan_check", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.governance.plan_check")
