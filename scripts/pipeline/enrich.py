"""Re-export stub: enrich.py moved to commands/knowledge/enrich.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.knowledge.enrich", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.knowledge.enrich")
