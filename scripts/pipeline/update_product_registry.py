"""Re-export stub: update_product_registry.py moved to commands/ops/update_product_registry.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.update_product_registry", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.update_product_registry")
