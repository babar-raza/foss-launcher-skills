"""Re-export stub: token_ops.py moved to commands/ops/token_ops.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.token_ops", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.token_ops")
