"""Re-export stub: remediate.py moved to commands/content/remediate.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.content.remediate", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.content.remediate")
