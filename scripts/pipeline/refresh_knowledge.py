"""Re-export stub: refresh_knowledge.py moved to commands/knowledge/refresh_knowledge.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.knowledge.refresh_knowledge", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.knowledge.refresh_knowledge")
