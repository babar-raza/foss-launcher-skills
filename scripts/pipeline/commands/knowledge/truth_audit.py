...
from audit import report_json, report_text, audit_product  # noqa: E402
...
def run_truth_audit(
    ...
    *,
    ...
    check_evidence: bool = True,  # foss: evidence checking always enabled; kwarg accepted for API compat
