"""Re-export stub: no_downgrade_guard.py moved to commands/governance/no_downgrade_guard.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.governance.no_downgrade_guard", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.governance.no_downgrade_guard")
