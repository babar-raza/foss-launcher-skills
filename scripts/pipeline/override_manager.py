"""Re-export stub: override_manager.py moved to commands/ops/override_manager.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.override_manager", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.override_manager")
