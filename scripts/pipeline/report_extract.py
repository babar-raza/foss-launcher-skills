"""Re-export stub: report_extract.py moved to commands/ops/report_extract.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.ops.report_extract", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.ops.report_extract")
