"""Re-export stub: backtrack_controller.py moved to commands/healing/backtrack_controller.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.healing.backtrack_controller", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.healing.backtrack_controller")
