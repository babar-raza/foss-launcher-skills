"""Re-export stub: heal_policy.py moved to commands/healing/heal_policy.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.healing.heal_policy", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.healing.heal_policy")
