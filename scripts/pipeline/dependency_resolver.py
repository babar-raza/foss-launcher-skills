"""Re-export stub: dependency_resolver.py moved to commands/healing/dependency_resolver.py.
...
if __name__ == "__main__":
    ...
    _runpy.run_module("commands.healing.dependency_resolver", run_name="__main__", alter_sys=True)
else:
    # Import delegation: alias this module to the real one
    _real = _importlib.import_module("commands.healing.dependency_resolver")
