# TC-P6-0028 - Reconcile evidence-enhance Capability

## Purpose

Resolve Phase 4 parity status for `evidence-enhance` without weakening standalone maintainability.

## Exact Scope

Inspect `evidence-enhance` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `.agents/skills/evidence-enhance/SKILL.md`

## Files/Areas Allowed To Change

- `skills/evidence-enhance.md`
- `.agents/skills/evidence-enhance/SKILL.md`
- `.claude/commands/evidence-enhance.md`
- `.kilocode/skills/evidence-enhance/SKILL.md`
...
1. Read the aspose.org and standalone records for `evidence-enhance` from the inventories.
2. Classify each gap category for `evidence-enhance` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/evidence-enhance-parity-verification.md`
...
`evidence-enhance` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
