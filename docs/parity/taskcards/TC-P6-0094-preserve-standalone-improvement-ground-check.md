# TC-P6-0094 - Preserve Standalone Improvement ground-check

## Purpose

Ensure standalone-only capability `ground-check` is not regressed while importing aspose.org parity behavior.
...
- `skills/ground-check.md`
- `.agents/skills/ground-check/SKILL.md`

## Files/Areas Allowed To Change

- `skills/ground-check.md`
- `.agents/skills/ground-check/SKILL.md`
- `.claude/commands/ground-check.md`
- `.kilocode/skills/ground-check/SKILL.md`
- `tests/**`
...
1. Confirm `ground-check` is registered and discoverable.
...
- `docs/parity/evidence/ground-check-preservation-review.md`
...
`ground-check` has a documented preserve, test, or deprecate decision.
