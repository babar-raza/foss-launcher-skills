# TC-P6-0095 - Preserve Standalone Improvement mental-model

## Purpose

Ensure standalone-only capability `mental-model` is not regressed while importing aspose.org parity behavior.
...
- `.agents/skills/mental-model/SKILL.md`

## Files/Areas Allowed To Change

- `skills/mental-model.md`
- `.agents/skills/mental-model/SKILL.md`
- `.claude/commands/mental-model.md`
- `.kilocode/skills/mental-model/SKILL.md`
- `tests/**`
...
1. Confirm `mental-model` is registered and discoverable.
...
- `docs/parity/evidence/mental-model-preservation-review.md`
...
`mental-model` has a documented preserve, test, or deprecate decision.
