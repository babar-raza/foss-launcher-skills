# TC-P6-0059 - Reconcile page-draft Capability

## Purpose

Resolve Phase 4 parity status for `page-draft` without weakening standalone maintainability.

## Exact Scope

Inspect `page-draft` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/page-draft.md`
- `.agents/skills/page-draft/SKILL.md`

## Files/Areas Allowed To Change

- `skills/page-draft.md`
- `.agents/skills/page-draft/SKILL.md`
- `.claude/commands/page-draft.md`
- `.kilocode/skills/page-draft/SKILL.md`
...
1. Read the aspose.org and standalone records for `page-draft` from the inventories.
2. Classify each gap category for `page-draft` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/page-draft-parity-verification.md`
...
`page-draft` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
