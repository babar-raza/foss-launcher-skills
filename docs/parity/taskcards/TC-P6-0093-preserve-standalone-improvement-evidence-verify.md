# TC-P6-0093 - Preserve Standalone Improvement evidence-verify

## Purpose

Ensure standalone-only capability `evidence-verify` is not regressed while importing aspose.org parity behavior.
...
- `skills/evidence-verify.md`
- `.agents/skills/evidence-verify/SKILL.md`

## Files/Areas Allowed To Change

- `skills/evidence-verify.md`
- `.agents/skills/evidence-verify/SKILL.md`
- `.claude/commands/evidence-verify.md`
- `.kilocode/skills/evidence-verify/SKILL.md`
- `tests/**`
...
1. Confirm `evidence-verify` is registered and discoverable.
...
- `docs/parity/evidence/evidence-verify-preservation-review.md`
...
`evidence-verify` has a documented preserve, test, or deprecate decision.
