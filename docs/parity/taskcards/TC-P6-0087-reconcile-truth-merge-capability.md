# TC-P6-0087 - Reconcile truth-merge Capability

## Purpose

Resolve Phase 4 parity status for `truth-merge` without weakening standalone maintainability.

## Exact Scope

Inspect `truth-merge` in both inventories and implement or document the target design: Run contract reconciliation against the aspose.org skill, then update standalone docs/scripts/tests to preserve practical behavior with cleaner structure.
...
- `skills/truth-merge.md`
- `.agents/skills/truth-merge/SKILL.md`

## Files/Areas Allowed To Change

- `skills/truth-merge.md`
- `.agents/skills/truth-merge/SKILL.md`
- `.claude/commands/truth-merge.md`
- `.kilocode/skills/truth-merge/SKILL.md`
...
1. Read the aspose.org and standalone records for `truth-merge` from the inventories.
2. Classify each gap category for `truth-merge` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/truth-merge-parity-verification.md`
...
`truth-merge` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
