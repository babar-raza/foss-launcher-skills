# TC-P6-0082 - Reconcile translate-page Capability

## Purpose

Resolve Phase 4 parity status for `translate-page` without weakening standalone maintainability.

## Exact Scope

Inspect `translate-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/translate-page.md`
- `.agents/skills/translate-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/translate-page.md`
- `.agents/skills/translate-page/SKILL.md`
- `.claude/commands/translate-page.md`
- `.kilocode/skills/translate-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `translate-page` from the inventories.
2. Classify each gap category for `translate-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/translate-page-parity-verification.md`
...
`translate-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
