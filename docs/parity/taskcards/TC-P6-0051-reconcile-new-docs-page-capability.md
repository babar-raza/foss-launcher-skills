# TC-P6-0051 - Reconcile new-docs-page Capability

## Purpose

Resolve Phase 4 parity status for `new-docs-page` without weakening standalone maintainability.

## Exact Scope

Inspect `new-docs-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `.agents/skills/new-docs-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/new-docs-page.md`
- `.agents/skills/new-docs-page/SKILL.md`
- `.claude/commands/new-docs-page.md`
- `.kilocode/skills/new-docs-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `new-docs-page` from the inventories.
2. Classify each gap category for `new-docs-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/new-docs-page-parity-verification.md`
...
`new-docs-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
