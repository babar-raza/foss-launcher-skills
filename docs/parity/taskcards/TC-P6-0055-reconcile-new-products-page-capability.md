# TC-P6-0055 - Reconcile new-products-page Capability

## Purpose

Resolve Phase 4 parity status for `new-products-page` without weakening standalone maintainability.

## Exact Scope

Inspect `new-products-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/new-products-page.md`
- `.agents/skills/new-products-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/new-products-page.md`
- `.agents/skills/new-products-page/SKILL.md`
- `.claude/commands/new-products-page.md`
- `.kilocode/skills/new-products-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `new-products-page` from the inventories.
2. Classify each gap category for `new-products-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/new-products-page-parity-verification.md`
...
`new-products-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
