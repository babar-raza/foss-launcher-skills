# TC-P6-0085 - Reconcile truth-audit-content Capability

## Purpose

Resolve Phase 4 parity status for `truth-audit-content` without weakening standalone maintainability.

## Exact Scope

Inspect `truth-audit-content` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `.agents/skills/truth-audit-content/SKILL.md`

## Files/Areas Allowed To Change

- `skills/truth-audit-content.md`
- `.agents/skills/truth-audit-content/SKILL.md`
- `.claude/commands/truth-audit-content.md`
- `.kilocode/skills/truth-audit-content/SKILL.md`
...
1. Read the aspose.org and standalone records for `truth-audit-content` from the inventories.
2. Classify each gap category for `truth-audit-content` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/truth-audit-content-parity-verification.md`
...
`truth-audit-content` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
