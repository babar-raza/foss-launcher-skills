# TC-P6-0057 - Reconcile new-reference-page Capability

## Purpose

Resolve Phase 4 parity status for `new-reference-page` without weakening standalone maintainability.

## Exact Scope

Inspect `new-reference-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `.agents/skills/new-reference-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/new-reference-page.md`
- `.agents/skills/new-reference-page/SKILL.md`
- `.claude/commands/new-reference-page.md`
- `.kilocode/skills/new-reference-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `new-reference-page` from the inventories.
2. Classify each gap category for `new-reference-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/new-reference-page-parity-verification.md`
...
`new-reference-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
