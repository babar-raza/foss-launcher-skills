# TC-P6-0026 - Reconcile eval-page Capability

## Purpose

Resolve Phase 4 parity status for `eval-page` without weakening standalone maintainability.

## Exact Scope

Inspect `eval-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/eval-page.md`
- `.agents/skills/eval-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/eval-page.md`
- `.agents/skills/eval-page/SKILL.md`
- `.claude/commands/eval-page.md`
- `.kilocode/skills/eval-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `eval-page` from the inventories.
2. Classify each gap category for `eval-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/eval-page-parity-verification.md`
...
`eval-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
