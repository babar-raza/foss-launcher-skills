# TC-P6-0052 - Reconcile new-kb-faq Capability

## Purpose

Resolve Phase 4 parity status for `new-kb-faq` without weakening standalone maintainability.

## Exact Scope

Inspect `new-kb-faq` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/new-kb-faq.md`
- `.agents/skills/new-kb-faq/SKILL.md`

## Files/Areas Allowed To Change

- `skills/new-kb-faq.md`
- `.agents/skills/new-kb-faq/SKILL.md`
- `.claude/commands/new-kb-faq.md`
- `.kilocode/skills/new-kb-faq/SKILL.md`
...
1. Read the aspose.org and standalone records for `new-kb-faq` from the inventories.
2. Classify each gap category for `new-kb-faq` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/new-kb-faq-parity-verification.md`
...
`new-kb-faq` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
