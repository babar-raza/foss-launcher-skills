# TC-P6-0069 - Reconcile refresh-product-page Capability

## Purpose

Resolve Phase 4 parity status for `refresh-product-page` without weakening standalone maintainability.

## Exact Scope

Inspect `refresh-product-page` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/refresh-product-page.md`
- `.agents/skills/refresh-product-page/SKILL.md`

## Files/Areas Allowed To Change

- `skills/refresh-product-page.md`
- `.agents/skills/refresh-product-page/SKILL.md`
- `.claude/commands/refresh-product-page.md`
- `.kilocode/skills/refresh-product-page/SKILL.md`
...
1. Read the aspose.org and standalone records for `refresh-product-page` from the inventories.
2. Classify each gap category for `refresh-product-page` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/refresh-product-page-parity-verification.md`
...
`refresh-product-page` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
