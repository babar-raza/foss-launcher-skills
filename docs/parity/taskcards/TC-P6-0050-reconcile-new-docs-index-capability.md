# TC-P6-0050 - Reconcile new-docs-index Capability

## Purpose

Resolve Phase 4 parity status for `new-docs-index` without weakening standalone maintainability.

## Exact Scope

Inspect `new-docs-index` in both inventories and implement or document the target design: Normalize this skill through the external content repo adapter so it works with standalone paths and never assumes in-repo Hugo content.
...
- `skills/new-docs-index.md`
- `.agents/skills/new-docs-index/SKILL.md`

## Files/Areas Allowed To Change

- `skills/new-docs-index.md`
- `.agents/skills/new-docs-index/SKILL.md`
- `.claude/commands/new-docs-index.md`
- `.kilocode/skills/new-docs-index/SKILL.md`
...
1. Read the aspose.org and standalone records for `new-docs-index` from the inventories.
2. Classify each gap category for `new-docs-index` as true missing behavior, intentional standalone redesign, stale reference, or verification-only.
...
- `docs/parity/evidence/new-docs-index-parity-verification.md`
...
`new-docs-index` is reclassified as parity-proven, intentionally standalone-different with evidence, or blocked with a precise next action.
